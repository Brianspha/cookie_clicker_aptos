...
/// aptos move create-resource-account-and-publish-package --seed [seed] --address-name mint_nft --profile default --named-addresses cookie_nft_address=[default account's address]
///
/// example output:
    /*
    2-Using-Resource-Account % aptos move create-resource-account-and-publish-package --seed 1235 --address-name mint_nft --profile default --named-addresses cookie_nft_address=a911e7374107ad434bbc5369289cf5855c3b1a2938a6bfce0776c1d296271cde
...
/// - 3.c In `mint_cookie_nft`, we create a resource signer by calling `account::create_signer_with_capability(&module_data.signer_cap)` to programmatically sign for `token::mint_token()` and `token::direct_transfer()` functions.
...
/// aptos move run --function-id [resource account's address]::create_nft_with_resource_account::mint_cookie_nft --profile nft-receiver
///
/// example output:
    /*
    2-Using-Resource-Account % aptos move run --function-id 55328567ff8aa7d242951af7fc1872746fbeeb89dfed0e1ee2ff71b9bf4469d6::create_nft_with_resource_account::mint_cookie_nft --profile nft-receiver
...
module cookie_nft_address::cookie_nft {
    ...
    public entry fun mint_cookie_nft(receiver: &signer) acquires ModuleData {
    ...
    public entry fun create_nft_module_test(origin_account: signer, resource_account: signer, nft_receiver: signer,  aptos_framework: signer) acquires ModuleData  {
